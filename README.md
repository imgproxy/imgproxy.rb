...
imgproxy.rb uses [anyway_config](https://github.com/palkan/anyway_config) to load configuration, so you can configure it different ways:
...
* **endpoint** (`IMGPROXY_ENDPOINT`) - Full URL to where your imgproxy lives. Default: `nil`.
